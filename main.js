var target = document.getElementById("song-list");
var music = {};
var songs = [];
...
songs.forEach(function(i) {
    ...
    target.innerHTML += "<li id='js-song'>" + song.name + "</li>" + "<li class='js-info'>" + song.artist + "</li>" + "<li class='js-info'>|</li>" + "<li class='js-info'>" + song.album + "</li>";
});
